...
public class IterateFtpDir {
    ...
    public IterateFtpDir(boolean isPrintCommmand){  
        ftp = new FTPClient();  
        log("host:"+Constant.FTP_HOST);
        log("port:"+Constant.FTP_PORT);
        log("user:"+Constant.FTP_USER);
        log("pwd:"+Constant.FTP_PASS);
        //String FTP_HOST="192.168.139.9";
    	//int FTP_PORT=21;
    	//String FTP_USER="applvis";
    	//String FTP_PASS="applvis";
        try {
        	//this.login(FTP_HOST,FTP_PORT, FTP_USER, FTP_PASS);
