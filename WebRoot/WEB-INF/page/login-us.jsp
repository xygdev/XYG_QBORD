  ...
  <body>
    ...
    <div id="welcome-page" style="opacity:1">
      ...
      <div class="dropdown langue-frame">
          ...
          <li role="presentation">
            <a role="menuitem" tabindex="-1" href="loginUS.do">ENG</a>
          </li>
        </ul>
      </div>
      <!-- 右上角区域 end -->
      ...
      <div class="logo-frame">
        ...
        <h1 class="logo-desc">XINYI GLASS</h1>
      </div>
      <!-- 左上角区域 end -->
      <!-- 正中间区域 start -->
      <div class="center-text">
        <h1 class="welcome-text">Welcome To XYG Automobile Glass Online Platform</h1> 
        <button type="button" class="btn start-btn">Click Here</button>   
      </div>
      <!-- 正中间区域 end -->  
      <!-- 背景图轮播区域 start -->
	...
	<div id='login-page'>
	  ...
	  <div class="login-frame">
	    ...
	    <hr></hr>
	    <p class="split-line" style="width:40%">Forget Password?</p>
