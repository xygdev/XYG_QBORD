	...
	<script>
		...
		function isPC(){
		    ...
		    if(browser.versions.mobile || browser.versions.ios || browser.versions.android ||   
		        ...
		        document.write('<div style="width:100%;height:100%;position:absolute;z-index:103;color:white;background:black;"><p style="font-size:3em;text-align:center;margin:300px 55px;letter-spacing:0.2em;line-height:1.8em;">This Terminal Can Not Visit Our Website.Please Try Again With Your Personal Computer!</p></div>');
