  ...
  <body>
    <div id="container">
      ...
      <div id="ui" class="pop_frame row-3">     
        ...
        <div class="foot">       
          <button class="right update_confirm pointer" data-type="update" data-keyup="enter" data-crudtype="update" data-pageframe="ui" data-updateurl="group/updateH.do" data-func="$().beforeInsert();">提交更新</button>
          <button class="right update_confirm pointer" data-type="insert" data-keyup="enter" data-crudtype="insert" data-pageframe="ui" data-inserturl="group/insertH.do" data-func="$().beforeInsert();">新增</button>
        </div>    
      </div> 
      <!-- 更新/新增工作组区域 end -->
      <!-- 工作组明细区域 start --> 
          ...
          <form>
             ...
             <div id="tabs-1" class="tab">
               <div style="margin-top:28px;">
                 <label for="GROUP_NAME_D" class="left md">工作组名称</label>
