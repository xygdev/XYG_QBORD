       ...
       <div id="scrollbar" class="table pointer">
         <table  id="main-table" data-table="Func">
            <tr>
               ...
               <th class="ICON_ID" style="display:none" data-column="hidden">&nbsp;</th>   
	         </tr>
             <tr>
		       ...
		       <td class="ICON_ID" style="display:none" data-column="hidden">&nbsp;</td>
	         </tr>
	       </table>
         </div>
	     <!-- 主表格区域 end -->
	     ...
	     <div class="table_button" id="table" data-table="Func">
	       ...
	       <input type="hidden" data-type="orderby" id="ORDER_BY" value="FUNCTION_ID"/>
