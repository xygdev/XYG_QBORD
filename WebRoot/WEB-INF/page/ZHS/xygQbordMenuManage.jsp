        ...
        <div class="detail_table">
          <table id="mLine" data-table="MenuLine">
            ...
            <tr>
              ...
              <td class="ACTION" data-column="normal">
                <i class="fa fa-trash fa-fw pointer hidden" data-show="true" title="删除" data-refresh="sub_refresh" data-crudtype="del" data-delurl="menu/deleteL.do" data-delmsg="是否删除序列:" data-col="MENU_SEQUENCE" data-delparam=["MENU_SEQUENCE",".MENU_SEQUENCE"] data-func="$().setParam();"></i>
              </td>
              <td class="MENU_ID" style="display:none" data-column="hidden">&nbsp;</td>                          
            </tr>
          </table>
    ...
    <script>       
        $(function() {    
            ...
            $.fn.beforeInsert = function(){
                ...
                RegExpValidate('^[\u4e00-\u9fa5\d0-9a-zA-Z]{0,}$','MENU_NAME','$("#MENU_NAME").val("");regExpError("菜单名称必须为汉字、字母和数字组合!");');
            }          
