	...
	<div class="lov_frame" id="lov" data-table="LOV">
      ...
      <div class="querybox">
        ...
        <div class="left lov_button">
          <i class="fa fa-search pointer" data-keyup="enter" data-crudtype="lovquery" data-load=".lov_loading" data-bg="loading-modal" data-pageframe="lov"></i>
        </div>
        <div class="left lov_button">
          <i class="fa fa-step-backward pointer" data-pagetype="firstpage" data-load=".lov_loading" data-pageframe="lov"></i>
        </div>  
        <div class="left lov_button">
          <i class="fa fa-arrow-circle-left pointer" data-pagetype="prevpage" data-load=".lov_loading" data-pageframe="lov"></i>
        </div>
