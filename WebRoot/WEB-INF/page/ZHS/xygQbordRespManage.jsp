   ...
   <body>
     <div id="container">
       ...
       <div id="scrollbar" class="table pointer">
         <table  id="main-table" data-table="Resp">
           <tr> 
             ...
             <th class="RESP_TYPE" data-column="db">职责类型</th>
       ...
       <div class="table_button" id="table" data-table="Resp">
         ...
         <div class="setting">
           <i class="fa fa-plus-circle pointer" data-reveal-id="ui" data-key="true" title="新增" data-dismissmodalclass="close-ui-frame" data-crudtype="pre-insert" data-type="insert" data-func="" data-revealfunc="$().afterReveal(); " ></i>
         </div>
         <div class="setting">
	   ...
	   <div id="query" class="pop_frame row-3">
         <div class="title pointer">
           <span><i class="fa fa-search"></i>&nbsp;职责查询</span>
         </div>
         ...
         <div class="content row-3">
           <form>
             ...
             <br style="clear:both"/>
             <label for="RESP_TYPE_Q" class="left md">职责类型:</label>
       ...
       <div id="ui" class="pop_frame row-4" >
         <div class="title pointer">
           <span data-type="update"><i class="fa fa-briefcase fa-1x" aria-hidden="true"></i>&nbsp;更新</span>
           <span data-type="insert"><i class="fa fa-briefcase fa-1x" aria-hidden="true"></i>&nbsp;新增</span>
         </div>
         ...
         <div class="content row-4">
           <form id="updateData">
             ...
             <input type="button" id="MENU_LOV" class="left button pointer" data-pageframe="lov" data-reveal-id="lov"  data-key="true" data-callback="ui" data-bg="lov-modal-bg" data-dismissmodalclass="close-lov" data-lovname="菜单查询" data-queryurl="lov/getMenuPage.do" data-jsontype="menu" data-defaultquery="true" data-th=["菜单ID","菜单编码","菜单名称","描述"] data-td=["MENU_ID&none","MENU_CODE","MENU_NAME","DESCRIPTION"] data-selectname=["菜单名称","菜单编码"] data-selectvalue=["MENU_NAME","MENU_CODE"] data-choose=[".MENU_ID",".MENU_NAME"] data-recid=["#MENU_ID","#MENU_NAME"] value="···"/>
             <br style="clear:both"/> 
             ...
             <label for="RESP_TYPE_U" class="left md">职责类型</label>
         ...
         <div class="foot">
           <button class="right update_confirm pointer" data-type="update" data-keyup="enter" data-crudtype="update" data-pageframe="ui" data-updateurl="resp/update.do" data-func="$().beforeInsert()">提交更新</button>
     ...
     <script>
          $(function() {
	          ...
	          $.fn.beforeInsert = function(){
	              ...
	              RegExpValidate('^[\u4e00-\u9fa50-9a-zA-Z ]{0,}$','RESP_NAME','$("#RESP_NAME").val("");regExpError("职责名称格式不符合规范!");');
	          }
