    ...
    <div id="container">
      ...
      <div id="scrollbar" class="table pointer">
        <table  id="main-table" data-table="Func">
          <tr>
	        <th class="FUNCTION_CODE" data-column="db">Code</th>
	        <th class="FUNCTION_NAME" data-column="db">Function</th>
	        <th class="FUNCTION_URL" data-column="db">Url</th>
	        <th class="DESCRIPTION" data-column="db">Description</th>
	        <th class="ICON_PREVIEW" data-column="normal">Icon</th>
      ...
      <div class="table_button" id="table" data-table="Func">
        ...
        <div class="setting">
          <i id="refresh" class="fa fa-refresh pointer" title="Refresh Query" data-pagetype="refresh" data-pageframe="table"></i>
        </div>
        <div id="setting">
          <!-- 设置菜单区域 start -->
      ...
      <div id="query" class="pop_frame row-1">
        ...
        <div class="content row-1">
	      <form>
            <label for="FUNCTION_CODE_Q" class="left md">Code:</label> 
	  ...
	  <div id="ui" class="pop_frame row-3" >
        <div class="title pointer">
          <span data-type="update"><i class="fa fa-puzzle-piece fa-1x" aria-hidden="true"></i>&nbsp;Update</span>
	      <span data-type="insert"><i class="fa fa-puzzle-piece fa-1x" aria-hidden="true"></i>&nbsp;Insert</span>
        </div>
        ...
        <div class="content row-3">
	      <form id="updateData">
	        ...
	        <label for="FUNCTION_NAME" class="left md">Function</label>
	        <input type="text" id="FUNCTION_NAME" name="FUNCTION_NAME" data-update="db" required="required" class="left lg"/>
	        <label for="FUNCTION_URL" class="left md">Url</label>
	    ...
	    <div class="foot">       
	      <button class="right update_confirm pointer" data-type="update" data-keyup="enter" data-crudtype="update" data-pageframe="ui" data-updateurl="func/update.do" data-func="$().beforeInsert();">Update</button>
	      <button class="right update_confirm pointer" data-type="insert" data-keyup="enter" data-crudtype="insert" data-pageframe="ui" data-inserturl="func/insert.do" data-func="$().beforeInsert();">Insert</button>
	    </div>    
	  </div> 
	  <!-- 更新/新增用户区域 end -->
	  <!-- 用户信息存放区域 start -->
	...
	<script>
	    $(function() {
	        ...
	        $.fn.beforeInsert = function(){
                ...
                RegExpValidate('^\\w+$','FUNCTION_CODE','$("#FUNCTION_CODE").val("");regExpError("The CODE is not up to standard!");');
                RegExpValidate('^[a-zA-Z0-9 ]+$','FUNCTION_NAME','$("#FUNCTION_NAME").val("");regExpError("The FUNCTION is not up to standard!");');
                RegExpValidate('^[a-zA-Z0-9/]{0,}\\.do$','FUNCTION_URL','$("#FUNCTION_URL").val("");regExpError("The URL is not up to standard!");');
            }
        }); 
