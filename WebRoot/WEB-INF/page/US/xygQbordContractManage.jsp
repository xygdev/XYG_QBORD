...
<!----------------------------------------------订单明细-------------------------------------------------------- -->      
      ...
      <div class="detail_frame" id="detail" style="width:100%;">
        ...
        <div class="table_button" id="sub_table" data-table="OrderLine">
          ...
          <div class="setting">
            <i class="fa fa-files-o pointer" title="BatchUpload" data-reveal-id="batch_update" data-bg="detail-modal-bg" data-dismissmodalclass="close-bu-frame"></i>
          </div>
          <div class="setting">
      ...
      <div id="detail_ui" class="pop_frame row-5" style="z-index:104">     
        ...
        <div class="foot">            
          <button class="right update_confirm pointer" style="margin-left:15px" data-type="insert" data-crudtype="insert" data-pageframe="detail_ui" data-inserturl="contract/insertL.do" data-afterdatafunc="$().sumLines();" data-refresh="sub_refresh" data-func="$().beforeConfirm();">Insert & Close</button>
          <button class="right update_confirm pointer" style="margin-right:0" data-type="insert" data-keyup="enter" data-crudtype="insert-noclose" data-pageframe="detail_ui" data-inserturl="contract/insertL.do" data-afterdatafunc="$().afterInsertL();" data-refresh="sub_refresh" data-func="$().beforeConfirm();">Insert</button>
      ...
      <div id="batch_update" class="pop_frame row-2" style="z-index:104">     
        <div class="title pointer">          
          <span><i class="fa fa-files-o  fa-1x" aria-hidden="true"></i>&nbsp;BatchImport</span>
        </div>
        ...
        <div class="content row-2">
          ...
          <form id="batchForm" enctype="multipart/form-data" method="post" >
            <a href="javascript:void(0);" class="upload pointer">SelectFile
        ...
        <div class="foot">   
          ...
          <button id="uploadBatch" class="right pointer" style="margin-left:15px">import</button>   
        </div>
      </div>
      <!-- 批量上传区域 end -->
