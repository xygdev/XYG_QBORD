    ...
    <div id="container">
      ...
      <div id="query" class="pop_frame row-2">     
        <div class="title pointer">      
          <span><i class="fa fa-search"></i>&nbsp;Customer User Query</span>
        </div>
      ...
      <div id="ui" class="pop_frame row-4">     
        ...
        <div class="foot">       
          ...
          <button class="right update_confirm pointer" data-type="insert" data-keyup="enter" data-crudtype="insert" data-pageframe="ui" data-inserturl="user/insertCust.do" data-func="$().beforeInsert();">Insert</button>
        </div>    
      </div> 
      <!-- 更新/新增用户区域 end -->
      ...
      <div class="detail_frame" id="detail">
        <div class="title pointer">      
          <span><i class="fa fa-handshake-o"></i>&nbsp;Customer Account Assign</span>
        </div>
