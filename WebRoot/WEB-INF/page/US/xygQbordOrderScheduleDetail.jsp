    ...
    <div id="container">
      ...
      <div id="scrollbar" class="table pointer">
        <table id="main-table" data-table="OrderScheduleH">
          <tr>
            <th class="LINE_NUM" data-column="db" style="min-width:50px">Line No</th>
            ...
            <th class="ERP_STATUS" data-column="db">erp Status</th>
            ...
            <th class="REQUIRED_QUANTITY" data-column="db">Req Qty</th>
            <th class="ORDER_QUANTITY" data-column="db">Order Qty</th>
            <th class="BH_QTY" data-column="db">BH Qty</th>
            <th class="FH_QTY" data-column="db">FH Qty</th>
      ...
      <div id="query" class="pop_frame row-5">     
        <div class="title pointer">      
          <span><i class="fa fa-search"></i>&nbsp;Order ScheduleDteail Query</span>
        </div>
        ...
        <div class="content row-5">
          <form>
            ...
            <br style="clear:both"/>
            <label for="DESCRIPTION_Q" class="left md">Description:</label>
