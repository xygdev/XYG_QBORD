    ...
    <div id="container">
      ...
      <div class="table pointer">
        <table id="main-table" data-table="Broadcast">
          <tr>
            <th class="BROADCAST_TITLE" data-column="db">Title</th>
            <th class="USER_DESC" data-column="db">Author</th>
     	    <th class="START_DATE" data-column="db">Start Date</th>
     	    <th class="END_DATE" data-column="db">End Date</th>
     	    <th class="ACTION" data-column="normal">Content</th> 
     	  ...
     	  <tr>
            ...
            <td class="USER_DESC" data-column="db"></td>
     	    ...
     	    <td class="ACTION" data-column="normal">
     	      <i class="fa fa-file-text fa-fw detail pointer hidden" data-show="true" title="Detail" data-reveal-id="detail" data-key="true" data-dismissmodalclass="close-detail-frame" data-crudtype="pre-update" data-preupdateurl="broadcast/getContent.do" data-updateparam=["BROADCAST_ID",".BROADCAST_ID"]></i>   	      
     	    </td>
      ...
      <div class="table_button" id="table" data-table="Broadcast">
        ...
        <div class="setting">
          <i class="fa fa-plus-circle pointer" data-reveal-id="ui" title="Publish" data-dismissmodalclass="close-ui-frame" data-crudtype="pre-insert" data-type="insert" data-revealfunc=""></i>
        </div>
        <div class="setting">
      ...
      <div id="query" class="pop_frame row-4">     
        ...
        <div class="content row-4">
          <form>
            <label for="USER_DESC_Q" class="left md">Author:</label> 
            ...
            <input type="button" id="USER_LOV_Q" class="left button pointer" data-pageframe="lov" data-reveal-id="lov"  data-key="true" data-callback="query" data-bg="lov-modal-bg" data-dismissmodalclass="close-lov" data-lovname="User Query" data-queryurl="lov/getUserPage.do" data-jsontype="user" data-defaultquery="true" data-th=["userid","Account","Name"] data-td=["USER_ID&none","USER_NAME","DESCRIPTION"] data-selectname=["Account","Name"] data-selectvalue=["USER_NAME","DESCRIPTION"] data-choose=[".USER_ID",".DESCRIPTION"] data-recid=["#USER_ID_Q","#USER_DESC_Q"] value="···"/>
            <br style="clear:both"/> 
            <label for="BROADCAST_TITLE_Q" class="left md">Title:</label> 
            ...
            <label for="END_DATE_F" class="left md">End Date:</label>
            <input type="text" id="END_DATE_F" name="END_DATE_F" class="left time" data-datatype="date" placeholder="End Date From"/>
            <label for="END_DATE_T" class="left blank"></label>
            <input type="text" id="END_DATE_T" name="END_DATE_T" class="left time" data-datatype="date" placeholder="End Date To"/>
          </form> 
        </div>
        <div class="foot">             
      ...
      <div id="ui" class="pop_frame row-9">     
        <div class="title pointer">      
          <span data-type="insert"><i class="fa fa-volume-up fa-1x" aria-hidden="true"></i>&nbsp;Publish</span>
        </div>
        <a class="close-ui-frame" data-type="close">&#215;</a>
        <div class="line"></div>
        <div class="content row-9">
          <form style="padding:0 30px">
            <label for="BROADCAST_TITLE" class="left" style="padding:0 8px 0 0;width:34px;margin:5px 0">Title</label>
            ...
            <br style="clear:both"/>
            <label for="START_DATE" class="left" style="padding:8px 8px 0 0" data-datatype="date">Start Date</label>
            <input type="text" id="START_DATE" name="START_DATE" class="left" style="width:222px" data-datatype="date" data-update="db"/>
            <label for="END_DATE" class="left" style="padding:8px 8px 0 8px" data-datatype="date">End Date</label>
            <input type="text" id="END_DATE" name="END_DATE" class="left" style="width:222px" data-datatype="date" required="required" data-update="db"/>  
            ...
            <label for="BROADCAST_CONTENT" class="hidden" style="padding:0">Content</label>
          </form>
        </div>
        <div class="foot">       
          <button class="right update_confirm pointer" data-type="insert" data-keyup="enter" data-crudtype="insert" data-pageframe="ui" data-inserturl="broadcast/insert.do">Publish</button>
        </div>    
      </div> 
      <!-- 发布公告区域 end --> 
      <!-- 公告内容区域 start -->
      <div id="detail" class="pop_frame row-9"> 
        <div class="title pointer">      
          <span><i class="fa fa-volume-up"></i>&nbsp;Content</span>
        </div>
        ...
        <div class="content row-9">
          <div style="padding:0 30px">
            ...
            <label for="BROADCAST_TITLE_D" class="left" style="padding:0 8px 0 0;width:34px">Title:</label>
            ...
            <label for="START_DATE_D" class="right" style="margin:6px 0;width:100px">Publish Date:</label>
            <br style="clear:both"/>
            <input id="USER_DESC_D"type="text" class="right" style="margin:-1px 0;border:0px;width:70px" data-update="db"/>
            <label for="USER_DESC_D" class="right" style="width:55px">Author:</label>
          </div>
        </div>
      </div>
      <!-- 公告内容区域 end --> 
